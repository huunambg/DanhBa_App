...
class InApp extends GetxController {
  ...
  void init() async {
    ...
    // Thử bỏ restorePreviousPurchases xem sao :3
  ...
  void _listenToPurchaseUpdated(List<PurchaseDetails> purchaseDetailsList) {
    purchaseDetailsList.forEach((PurchaseDetails purchaseDetails) async {
      if (purchaseDetails.status != PurchaseStatus.pending) {
        ...
        // Khi mua hàng mà mạng không ổn định thì sẽ bị lỗi "You already own this item"
        // Khi mua hàng dạng consume thì có 2 bước là mua hàng
        // sau đó dùng (consume) món hàng đó.
        // Nếu vừa mua xong nhưng rớt mạng thì trạng thái món hàng đó sẽ là pending
        // (chờ tiêu thụ) => Không thể mua được lần nữa
        // Dù có để autoConsume = true thì vẫn bị lỗi
        // Do đó fix là consume thủ công những món hàng pending
        if (Platform.isAndroid) {
